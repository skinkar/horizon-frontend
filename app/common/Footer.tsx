export default function Footer() {
    return (
        <footer className="bg-white text-gray-800">
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="pb-10 flex flex-col md:flex-row justify-between gap-10 text-sm font-gilroy-medium">
                        ...
                        <div className="flex flex-col items-center">
                            <h4 className="font-gilroy-semibold mb-3 uppercase text-sm">Contact Us</h4>
                        ...
                        {/* Address */}
                        <div className="flex flex-col items-center">
                            <h4 className="font-gilroy-semibold mb-3 uppercase text-sm">Address</h4>
                        ...
                        {/* Social */}
                        <div className="flex flex-col items-center">
                            <h4 className="font-gilroy-semibold mb-3 uppercase text-sm ">Follow Us</h4>
            ...
            <div className="bg-gray-100 py-4 text-center text-sm font-gilroy-semibold text-gray-600">
